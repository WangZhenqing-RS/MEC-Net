...
def build_building(img_copy, mask_copy, img_target, mask_target, random, 
                   is_avoid_overwrite=True):
...
# # 复制粘贴数据增强
# mask, img = build_building(img_src, mask_src, img_main, mask_main, random)
