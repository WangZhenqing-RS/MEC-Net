...
def evaluation(label_folder, pred_floder, only_center=False):
    ...
    print(f"F1-Score: {f1ccore[1]}")
    print(f"IoU: {IoU[1]}")
    print(f"IoU_edge: {IoU_edge_area[1]}")
...
if __name__ == "__main__":
    ...
    for decoder_name in decoder_name_list:
        label_folder = '../data/Inria_Building_Dataset/test/label/*.tif'
        pred_floder = f'../data/Inria_Building_Dataset/test/pred_{decoder_name}/*.tif'
        print("====================================")
        print(decoder_name)
        print("============================")
    ...
    # label_folder = '../data/Inria_Building_Dataset/val/label/*.tif'
    # pred_floder = '../data/Inria_Building_Dataset/val/pred_fusion/*.tif'
    # print("====================================")
    # print("fusion")
    # print("================================")
