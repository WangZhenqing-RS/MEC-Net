# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 19:59:21 2022
...
from nets.batchnorm import SynchronizedBatchNorm2d
import numpy as np
...
class Activation(nn.Module):
    ...
    def __init__(self, name, **params):
        ...
        if name is None or name == 'identity':
            ...
            raise ValueError('Activation should be callable/sigmoid/softmax/None; got {}'.format(name))
...
class HRNetV2(nn.Module):
    def __init__(self, n_class, activation=None, **kwargs):
...
def hrnetv2(n_class, activation=None, pretrained_model=None, **kwargs):
    model = HRNetV2(n_class=n_class, activation=activation, **kwargs)
