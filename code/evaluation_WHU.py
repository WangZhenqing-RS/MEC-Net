...
if __name__ == "__main__":
    ...
    for decoder_name in decoder_name_list:
        ...
        pred_floder = f'../data/WHU_Building_Dataset/test/pred_{decoder_name}/*.tif'
        print("====================================")
        print(decoder_name)
        print("============================")
    ...
    label_folder = '../data/WHU_Building_Dataset/test/label/*.tif'
    pred_floder = '../data/WHU_Building_Dataset/test/pred_fusion/*.tif'
    print("====================================")
    print("fusion")
    print("================================")
    evaluation(label_folder, pred_floder, only_center=True)